...
namespace Downloader
{
    internal class CustomSettingsProvider : SettingsProvider
    {
        ...
        private void LoadValuesFromFile()
        {
            ...
            var settingElements = configXml.Element(CONFIG).Element(USER_SETTINGS).Element("Downloader.Properties.Settings").Elements(SETTING);
        ...
        {
            Directory.CreateDirectory($"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\\YouTube Downloader");
            ...
            var group = new XElement("Downloader.Properties.Settings");
        ...
        private void SaveValuesToFile()
        {
            ...
            var settingsSection = import.Element(CONFIG).Element(USER_SETTINGS).Element("Downloader.Properties.Settings");
        ...
        private static string UserConfigPath
        {
            get
            {
                return $"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\\YouTube Downloader\\user.config";
            }
